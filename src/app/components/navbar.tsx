  ...
  return (
    <nav className="fixed top-0 w-full bg-transparent text-white z-50">
      ...
      <div className="md:hidden relative">
        <div
          ref={circleRef}
          className="fixed top-0 right-0 w-20 h-20 bg-gray-800 rounded-full transform scale-0 origin-top-right z-40"
        ></div>
        <div
          className={`fixed inset-0 flex flex-col items-center justify-center bg-gray-800 transition-opacity duration-300 ease-in-out ${
        ...
        >
          ...
          {["Home", "Products", "About",].map((item, index) => (
            <a
              ...
              className="block px-3 py-2 rounded-md text-base font-medium text-white hover:text-gray-400 transition duration-200"
